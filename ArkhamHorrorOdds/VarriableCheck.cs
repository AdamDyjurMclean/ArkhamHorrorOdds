    ...
    public static class VarriableCheck
    {
        ...
        public static string Label(int campaign, int scenerio, int difficulty)
        {
            ...
            if(Enumerable.SequenceEqual(array, new int[] { 0, 0, 0 }))
                ...
                Enumerable.SequenceEqual(array, new int[] { 4, 5, 0 }) || Enumerable.SequenceEqual(array, new int[] { 5, 7, 0 }))
                return "Highest Doom";
                ...
                Enumerable.SequenceEqual(array, new int[] { 4, 5, 2 }) || Enumerable.SequenceEqual(array, new int[] { 5, 7, 2 }))
                return "Total Doom";
                ...
                return "Signs #";
            else if (Enumerable.SequenceEqual(array, new int[] { 5, 4, 0 }) || Enumerable.SequenceEqual(array, new int[] { 5, 4, 2 }))
                return "Alarm Level";
                ...
                return "Act #";
            else if (Enumerable.SequenceEqual(array, new int[] { 6, 2, 0 }) || Enumerable.SequenceEqual(array, new int[] { 6, 2, 2 }))
                return "East #";
            else if (Enumerable.SequenceEqual(array, new int[] { 6, 3, 0 }) || Enumerable.SequenceEqual(array, new int[] { 6, 3, 2 })
                    || Enumerable.SequenceEqual(array, new int[] { 6, 6, 0 }) || Enumerable.SequenceEqual(array, new int[] { 6, 6, 2 }))
                return "# of keys";
